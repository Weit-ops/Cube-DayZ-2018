...
namespace CodeStage.AdvancedFPSCounter
{
	...
	public class AFPSCounter : MonoBehaviour
	{
		...
		private void ProcessHotKey()
		{
			...
			if (ControlFreak2.CF2Input.GetKeyDown(hotKey))
			{
				var modifiersPressed = true;

				if (hotKeyCtrl)
				{
					modifiersPressed &= ControlFreak2.CF2Input.GetKey(KeyCode.LeftControl) || ControlFreak2.CF2Input.GetKey(KeyCode.RightControl) || ControlFreak2.CF2Input.GetKey(KeyCode.LeftCommand) || ControlFreak2.CF2Input.GetKey(KeyCode.RightCommand);
				}

				if (hotKeyAlt)
				{
					modifiersPressed &= ControlFreak2.CF2Input.GetKey(KeyCode.LeftAlt) || ControlFreak2.CF2Input.GetKey(KeyCode.RightAlt);
				}

				if (hotKeyShift)
				{
					modifiersPressed &= ControlFreak2.CF2Input.GetKey(KeyCode.LeftShift) || ControlFreak2.CF2Input.GetKey(KeyCode.RightShift);
				}
