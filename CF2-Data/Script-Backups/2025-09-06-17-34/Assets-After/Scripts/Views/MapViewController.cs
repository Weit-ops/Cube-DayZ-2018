...
public class MapViewController : MonoBehaviour
{
	...
	[SerializeField] GameObject _mySectorView;

	private Vector2[,] _sectorsPosition;
	private bool _isInitialized;

	[SerializeField] Transform _leftFogSide;
	[SerializeField] Transform _rightFogSide;
	[SerializeField] Transform _topFogSide;
	[SerializeField] Transform _bottomFogSide;
	[SerializeField] Transform _safetyLeftFogSide;
	[SerializeField] Transform _safetyRightFogSide;
	[SerializeField] Transform _safetyTopFogSide;
	[SerializeField] Transform _safetyBottomFogSide;
	[SerializeField] Transform _safetyZoneArea;
	[SerializeField] Renderer[] _fogRenderes;
	...
	public void CalculateSafetyFogArea()
	{
		...
		Debug.Log("Draw safity gas area!!");
	}
	...
	private void Update()
	{
		if (ControlFreak2.CF2Input.GetKeyUp(KeyCode.J))
		{
			CalcDistance();
		}
	}
