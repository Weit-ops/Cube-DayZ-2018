...
public class PlayerWeapons : MonoBehaviour {
	...
	void Update (){
		...
		&& !sprintSwitching){//don't allow weapon switching while sprint anim is active/transitioning
			...
			//drop weapons
			if(ControlFreak2.CF2Input.GetKeyDown(_fpsPlayerComponent.dropWeapon) 
			&& currentWeapon != 0
			...
			if (CanSelectWeaponByScroll) {
				if (ControlFreak2.CF2Input.GetAxis ("Mouse ScrollWheel") < 0 || ControlFreak2.CF2Input.GetKeyDown (_fpsPlayerComponent.selectPreviousWeapon)) {//mouse wheel down or previous weapon button pressed
				...
				} else if (ControlFreak2.CF2Input.GetAxis ("Mouse ScrollWheel") > 0//mouse wheel up
				        || ControlFreak2.CF2Input.GetKeyDown (_fpsPlayerComponent.selectNextWeapon)//select next weapon button pressed
			...
			if (CanSelectWeaponByKeys) {
				if (ControlFreak2.CF2Input.GetKeyDown (_fpsPlayerComponent.holsterWeapon)) {
					if (currentWeapon != 0) {
						StartCoroutine (SelectWeapon (0));
					}
				} else if (ControlFreak2.CF2Input.GetKeyDown (_fpsPlayerComponent.selectWeapon1)) {
					if (currentWeapon != 1) {
						StartCoroutine (SelectWeapon (1));
					}
				} else if (ControlFreak2.CF2Input.GetKeyDown (_fpsPlayerComponent.selectWeapon2)) {
					if (currentWeapon != 2) {
						StartCoroutine (SelectWeapon (2));
					}
				} else if (ControlFreak2.CF2Input.GetKeyDown (_fpsPlayerComponent.selectWeapon3)) {
					if (currentWeapon != 3) {
						StartCoroutine (SelectWeapon (3));
					}
				} else if (ControlFreak2.CF2Input.GetKeyDown (_fpsPlayerComponent.selectWeapon4)) {
					if (currentWeapon != 4) {
						StartCoroutine (SelectWeapon (4));
					}
				} else if (ControlFreak2.CF2Input.GetKeyDown (_fpsPlayerComponent.selectWeapon5)) {
					if (currentWeapon != 5) {
						StartCoroutine (SelectWeapon (5));
					}
				} else if (ControlFreak2.CF2Input.GetKeyDown (_fpsPlayerComponent.selectWeapon6)) {
					if (currentWeapon != 6) {
						StartCoroutine (SelectWeapon (6));
					}
				} else if (ControlFreak2.CF2Input.GetKeyDown (_fpsPlayerComponent.selectWeapon7)) {
					if (currentWeapon != 7) {
						StartCoroutine (SelectWeapon (7));
					}
				} else if (ControlFreak2.CF2Input.GetKeyDown (_fpsPlayerComponent.selectWeapon8)) {
					if (currentWeapon != 8) {
						StartCoroutine (SelectWeapon (8));
					}
				} else if (ControlFreak2.CF2Input.GetKeyDown (_fpsPlayerComponent.selectWeapon9)) {
					if (currentWeapon != 9) {
						StartCoroutine (SelectWeapon (9));
					}
				} else if (ControlFreak2.CF2Input.GetKeyDown (_fpsPlayerComponent.selectWeapon10)) {
					if (currentWeapon != 9) {
