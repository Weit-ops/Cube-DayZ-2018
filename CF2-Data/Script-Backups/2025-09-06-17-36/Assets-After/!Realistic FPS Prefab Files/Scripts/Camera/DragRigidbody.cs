//DragRigidbody.cs by Azuline StudiosВ© All Rights Reserved
...
public class DragRigidbody : MonoBehaviour {
    ...
    void Update(){
		...
		if(!ControlFreak2.CF2Input.GetKeyDown(FPSPlayerComponent.moveObject) || FPSPlayerComponent.zoomed || FPSPlayerComponent.hitPoints < 1.0f){
			return;
		}
    ...
    IEnumerator DragObject ( float distance  ){
		...
		while(ControlFreak2.CF2Input.GetKey(FPSPlayerComponent.moveObject) 
		...
		&& FPSPlayerComponent.hitPoints > 0.0f){
            ...
            if(!ControlFreak2.CF2Input.GetKey(FPSPlayerComponent.throwObject)){
