...
public class MouseOrbit : MonoBehaviour
{
	...
	private void LateUpdate()
	{
		if (Target != null)
		{
			x += ControlFreak2.CF2Input.GetAxis("Mouse X") * xSpeed * 0.02f;
			...
			if (ControlFreak2.CF2Input.GetAxis("Mouse ScrollWheel") != 0f)
			{
				...
				distance = ZoomLimit(distance - ControlFreak2.CF2Input.GetAxis("Mouse ScrollWheel") * scrollSpeed, zoomMin, zoomMax);
