...
public class PlaceItemViewController : MonoBehaviour
{
	...
	[SerializeField] Transform _placeItemHolder;
	...
	{
		_info = WorldController.I.Info.GetDestructibleObjectInfo(id);
	...
	private void Update()
	{
		...
		if (!Physics.Raycast(position, forward, out _hit, 10f, ItemsRegistry.I.ItemsCollisionsMask))
		{
			return;
		}
		...
		else if (ControlFreak2.CF2Input.GetMouseButton(1))
		{
