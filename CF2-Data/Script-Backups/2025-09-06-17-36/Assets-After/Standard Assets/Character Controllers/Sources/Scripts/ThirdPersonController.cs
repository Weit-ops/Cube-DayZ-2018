...
public class ThirdPersonController : MonoBehaviour
{
    ...
    void UpdateSmoothedMovementDirection()
    {
        ...
        float v = ControlFreak2.CF2Input.GetAxisRaw("Vertical");
    ...
    {
        return Mathf.Abs(ControlFreak2.CF2Input.GetAxisRaw("Vertical")) + Mathf.Abs(ControlFreak2.CF2Input.GetAxisRaw("Horizontal")) > 0.5f;
    }
