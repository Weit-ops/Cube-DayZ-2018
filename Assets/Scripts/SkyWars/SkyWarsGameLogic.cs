...
namespace SkyWars
{
	public class SkyWarsGameLogic : Photon.MonoBehaviour
	{
		...
		[SerializeField] AudioSource  _sirenaSound;
		[SerializeField] GameObject   _redButton;
		[SerializeField] Transform[]  _crateSpawnPoints;
		[SerializeField] SkyWarsBreageMoving[] _bridges;
		[SerializeField] SkyWarsIsland[] _islands;
