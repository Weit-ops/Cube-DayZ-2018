...
{
	[SerializeField] int _slotsOnRow;
	[SerializeField] List<SlotViewController> _slotsViewController;
	[SerializeField] tk2dUIScrollbar _scrollbar;
	[SerializeField] StorageViewController _storageView;
	[SerializeField] GameObject _equipmentView;
	[SerializeField] SelectedSlotInfoView _selectedSlotView;
