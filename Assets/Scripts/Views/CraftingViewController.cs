...
public class CraftingViewController : MonoBehaviour
{
	...
	[SerializeField] List<RecipeView> _recipeViews;
	[SerializeField] tk2dUIToggleButtonGroup _tabs;
	[SerializeField] tk2dUIScrollbar _scrollbar;
	...
	public void Social_AddWallPost_AskForCraftingResources()
	{
		JsSpeeker.I.WallPostSomething("ask_for_crafting_resources", "Братюня, помоги с запчастями для крафтинга!\r\n        Cube Day Z: Игра в лучших традициях DayZ, Unturned, H1Z1!");
	}
