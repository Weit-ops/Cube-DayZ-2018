...
public class StorageViewController : MonoBehaviour
{
	...
	[SerializeField] GameObject _howManyWindow;
	[SerializeField] tk2dUIProgressBar _howManyProgress;
	[SerializeField] tk2dUIScrollbar _howManyScrollbar;
	[SerializeField] tk2dTextMesh _currentCount;
