...
public class SelectedSlotInfoView : MonoBehaviour
{
	...
	[SerializeField] ShadowText _title;
	[SerializeField] ShadowText _description;
	[SerializeField] tk2dTextMesh _equipText;
	[SerializeField] tk2dTextMesh _currentHotKey;
	[SerializeField] EquipmentViewController _equipmentViewController;
	[SerializeField] HowManyWindowController _howManyWindow;
	[SerializeField] GameObject _equipButton;
	[SerializeField] GameObject _hotKeyPopup;
	[SerializeField] tk2dUIToggleButtonGroup _hotKeys;
	...
	private void OnClickDrop()
	{
		...
		ObscuredByte ammo = _selectedSlot.Ammo;
