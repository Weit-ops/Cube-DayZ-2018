...
namespace BattleRoyale
{
	public class BattleRoyaleGameManager : Photon.MonoBehaviour
	{
		...
		[SerializeField] tk2dTextMesh _gasInfoMsg;

		public static BattleRoyaleGameManager I;

		private bool _isLobby = true;

		[SerializeField] AudioSource _killSound;

		public GameObject Buttons;
		public GameObject BattleRoyalFinalScreen;

		[SerializeField] tk2dTextMesh[] _killLogs;
		[SerializeField] GameObject[] _fogsRenderers;
		[SerializeField] BattleRoyaleDisableAfter _remainPlayerFade;
		...
		public void StartShowKillLog(string killerName, string killedName, string weaponid, string atakerid)
		{
			base.photonView.RPC("ShowKillLog", PhotonTargets.All, killerName, killedName, weaponid, atakerid);
		}

		[PunRPC]
		public void ShowKillLog(string killerName, string killedName, string weaponId, string atakerid)
		{
			string empty = string.Empty;
			if (string.IsNullOrEmpty(killerName) && string.IsNullOrEmpty(weaponId) && string.IsNullOrEmpty(atakerid))
			{
