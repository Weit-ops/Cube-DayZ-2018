...
public class PlayerSpawnsController : MonoBehaviour
{
	...
	[SerializeField] int _maxSpawnRetries = 5;
	[SerializeField] List<PlayerSpawn> _availableSpawns;
	[SerializeField] PlayerSpawn _battleRoyaleLobbySpawn;
	...
	public void Respawn(bool firstSpawn, Vector3? positionFromSave = null)
	{
		...
		WorldController.I.WaitingBack.SetActive(false);
	}
}
