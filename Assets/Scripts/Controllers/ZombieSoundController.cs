...
public class ZombieSoundController : MonoBehaviour
{
	...
	[SerializeField] float _zombieVoiceVolume;
	[SerializeField] float _calmSoundMinTimeout = 3f;
	[SerializeField] float _calmSoundMaxTimeout = 6f;
	[SerializeField] List<AudioClip> _calmSounds;
	[SerializeField] List<AudioClip> _attackSounds;
	[SerializeField] List<AudioClip> _getHurtSounds;
	[SerializeField] List<AudioClip> _findTargetSounds;
	[SerializeField] List<AudioClip> _dieSounds;
