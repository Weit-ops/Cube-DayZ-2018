...
public class ZombiesCustomizer : MonoBehaviour
{
	...
	private void CustomizeZombie()
	{
		...
		_zombie.material.SetTexture("_HeadTex", ItemsRegistry.I.GetClothingTexture(_currentViewInfo.HeadTexId));
		_zombie.material.SetTexture("_BodyTex", ItemsRegistry.I.GetClothingTexture(_currentViewInfo.BodyTexId));
		_zombie.material.SetTexture("_LegsTex", ItemsRegistry.I.GetClothingTexture(_currentViewInfo.LegsTexId));
	}
