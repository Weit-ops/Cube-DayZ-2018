...
public class PhotonView : Photon.MonoBehaviour
{
    ...
    /// <param name="targetPlayer">The group of targets and the way the RPC gets sent.</param>
    /// <param name="parameters">The parameters that the RPC method has (must fit this call!).</param>
    public void RPC_ToListOfPlayers(string methodName, PhotonPlayer[] players, params object[] parameters)
    {
        PhotonNetwork.RPC_ToListOfPlayers(this, methodName, players, false, parameters);
    }
